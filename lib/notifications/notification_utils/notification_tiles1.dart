...
class NotificationBar1 extends StatefulWidget {
  const NotificationBar1({super.key});

  @override
  State<NotificationBar1> createState() => _NotificationBar1State();
}

class _NotificationBar1State extends State<NotificationBar1> {
  @override
